document.addEventListener('DOMContentLoaded', function () {
  ...
  const samplePosts = [
    {
      ...
      excerpt:
        "Struggling with writer's block? These creative prompts will help you get your creativity flowing again...",
      url: '/blog/creative-writing-prompts',
    },
    {
      title: 'The Ultimate Guide to Sustainable Living',
      excerpt:
        'Learn how small changes in your daily habits can lead to a more sustainable and eco-friendly lifestyle...',
      url: '/blog/sustainable-living-guide',
    },
    {
      title: 'How Mindfulness Can Transform Your Daily Routine',
      excerpt:
        'Discover the benefits of incorporating mindfulness practices into your everyday life and how it can reduce stress...',
      url: '/blog/mindfulness-daily-routine',
    },
    {
      title: 'Essential Photography Tips for Beginners',
      excerpt:
        'Want to improve your photography skills? These fundamental tips will help you take better photos right away...',
      url: '/blog/photography-tips-beginners',
    },
    {
      title: 'The Science Behind Effective Learning Techniques',
      excerpt:
        'Research-backed methods to enhance your learning efficiency and retain information longer...',
  ...
  function displayRandomPost() {
    ...
    const randomPostContainer = document.getElementById(
  ...
  function activateEasterEgg() {
    ...
    document.querySelector('.error-description').textContent =
      'The Konami code works even on 404 pages. How cool is that?';
  }
});

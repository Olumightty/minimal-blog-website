...
export const PostSchema = new Schema({
    ...
    category: {type: String, enum: ['design', 'technology', 'lifestyle', 'productivity', 'creativity']},
    tags: String,
    imageUrl: String,
...
export const UserSchema = new Schema({
    ...
    avatar: { type: String, default: 'https://res.cloudinary.com/dwxqkk8gd/image/upload/w_1000,c_fill,ar_1:1,g_auto,r_max,bo_5px_solid_red,b_rgb:262c35/v1745894943/profile_zqog5s.png'}, //fetch from oauth service if available
